...
def process_song_data(spark, input_data, output_data):
    """
    Load song_data from S3 and processe it by extracting the songs and artist tables and load to S3
        Parameters:
            spark: SparkSession object;
            input_data (string): The path of song_data json files;
            output_data (string): The path of S3 bucket  where the output tables are to be written;
        Returns:
            None
    """
...
def process_log_data(spark, input_data, output_data):
    """
    Writes data into users_table, time_table, songplays table.
        Parameters:
            spark: SparkSession object;
            input_data (string): The path of song_data json files;
            output_data (string): The path of S3 bucket  where the output tables are to be written;
...
def main():
    ...
    output_data = "s3a://dend-bucket-demo001/"
